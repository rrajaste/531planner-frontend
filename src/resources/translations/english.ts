...
export const English: IAppTranslation = {
    ...
    routines: {
        indexTitle: "Workout routines",
        indexSubtext: "Here you can view and manage your workout routines. " +
            "If you do not have any active workout routines, you can generate them here!",
        activeRoutine: "Active routine",
        noActiveRoutine: "No active routines",
        click: "Click",
        here: "HERE",
        toGenerate: "to generate a new one!",
        currentWeek: "Current week",
        noCurrentWeek: "No currently active week",
        generateTitle: "Generate...",
        generateSubtitle: "...a new workout routine",
        generateSubtext: "Fill out the form below to generate a new 5/3/1 workout routine",
        back: "Back",
        routineTemplates: "Routine templates",
        pleasePick: "Please choose a base routine template",
        repick: "Repick",
        select: "Select",
        liftMaxes: "Lift maxes",
        squat: "Squat",
        bench: "Bench press",
        deadlift: "Deadlift",
        ...
        calculate: "Calculate",
        estimatedOneRepMaxes: "Estimated one rep maxes",
        submit: "Submit",
        viewFullcycle: "View full cycle",
        delete: "Delete",
        close: "Close",
        deleteConfirm: "Are you sure you wish to delete this routine?",
        trainingWeek: "TrainingWeek",
        noWeightHoverTest: "Weight for this exercise is not programmable, use your best judgement",
