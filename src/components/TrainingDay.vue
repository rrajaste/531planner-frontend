<template>
    <div class="m-1 p-0">
        ...
        <li v-for="mainLift in trainingDay.mainLifts" :key="mainLift.id" class="text-secondary list-group-item">
        ...
        <li v-for="accessory in trainingDay.accessoryLifts" :key="accessory.id" class="text-secondary list-group-item">
